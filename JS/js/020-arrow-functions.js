...
function helloFunction(name) {
  ...
  const multiplyWithReturn = (num1, num2) => { // birden fazla islem yapilacaksa suslu parantez kullanilabilir..
    return num1 * num2
  }
  
  const multiplyWithReturnV2 = (num1, num2) => num1 * num2 // return kelimesi kullanilmadan da return yapilabilir..
